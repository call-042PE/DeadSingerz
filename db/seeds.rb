...
Singer.create!(name: "Janis Joplin", description: , category: "rock", price: 500, bio: "American singer-songwriter who sang rock, soul, and blues music. One of the most successful and widely known rock stars of her era", death_year: 1970, birth_year: 1943, user: user_4)
...
img_category_4 = URI.open(https://res.cloudinary.com/ddkm6bg5l/image/upload/v1648550856/DeadSingerz/Bob_Marley_auknhy.jpg)
img_category_5 = URI.open(https://res.cloudinary.com/ddkm6bg5l/image/upload/v1648550925/DeadSingerz/Kurt_Cobain_xjsnha.webp)
img_category_6 = URI.open(https://res.cloudinary.com/ddkm6bg5l/image/upload/v1648550966/DeadSingerz/Lil_Peep_wl7ltl.jpg)
img_category_7 = URI.open(https://res.cloudinary.com/ddkm6bg5l/image/upload/v1648551001/DeadSingerz/Serge_Gainsbourg_aaflth.webp)
img_category_8 = URI.open(https://res.cloudinary.com/ddkm6bg5l/image/upload/v1648551119/DeadSingerz/Janis_Joplin_v1dt7p.jpg)
...
category_2 = Singer.create!(name: "Jim Morrrison", description: "American singer, poet and songwriter who was the lead vocalist of the rock band the Doors.")
category_2.photo.attach(io: img_category_2, filename: 'Jim_Morrison.png', content_type: 'image/png')

category_3 = Singer.create!(name: 'Jimi Hendrix', description: "American musician, singer, and songwriter. Considered one of the most influential guitar Hero of all time")
category_3.photo.attach(io: img_category_3, filename: 'Jimi_Hendrix.png', content_type: 'img/png')

category_4 = Singer.create!(name: 'Bob Marley', description: "Jamaican singer, songwriter, and musician. Considered one of the pioneers of reggae")
category_4.photo.attach(io: img_category_4, filename: 'Bob_Marley.png', content_type: 'img/png')

category_5 = Singer.create!(name: 'Kurt Cobain', description: "American singer, songwriter, artist and musician. He was the frontman of the rock band Nirvana.")
...
category_8 = Singer.create!(name: "Janis Joplin", description: "American singer-songwriter who sang rock, soul, and blues music. One of the most successful and widely known rock stars of her era")
category_8.photo.attach(io: img_category_8, filename: 'Janis_Joplin.png', content_type: 'img/png')

category_9 = Singer.create!(name: "Johnny Halliday", description: "French rock and roll and pop singer and actor, credited for having brought rock and roll to France.")
category_9.photo.attach(io: img_category_9, filename: 'Johnny_Halliday.png', content_type: 'img/png')

category_10 = Singer.create!(name: 'Daniel Balavoine', description: " French singer and songwriter. He was hugely popular in the French-speaking world, and inspired many singers in the 1980s.")
category_10.photo.attach(io: img_category_10, filename: 'Daniel_Balavoine.png', content_type: 'img/png')

category_11 = Singer.create!(name: 'Elvis Presley', description: "American singer and actor. Dubbed the 'King of Rock and Roll', he is regarded as one of the most significant cultural icons of the 20th century.")
category_11.photo.attach(io: img_category_11, filename: 'Elvis_Presley.png', content_type: 'img/png')

category_12 = Singer.create!(name: 'Henri Salvador', description: "French Caribbean comedian, singer and cabaret artist.")
